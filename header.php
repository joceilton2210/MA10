...
<body>
 ...
 <form method="get" action="<?php get_home_url($blog_id, $path, $scheme);?>" id="buscador2" onsubmit="busca2(event)">
        ...
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a href="http://127.0.0.1/oficial/">
              ...
              <!-- BUSCA DO SITE -->
              <!--<div class="search-alt pull-right hidden-xs">
 <form method="get" action="#" id="buscador2" onsubmit="busca2(event)">
 <input type="hidden" name="termo" id="termo2">
 <input type="search" name="q" id="q2" placeholder="Buscar" value="">
 <button type="submit">
 </button></form></div>-->
      ...
      <div class="nav-dark" data-spy="affix" data-offset="188">
        <div class="container">
          <a href="http://127.0.0.1/oficial" class="logo-affix">
        </a>
          ...
          <?php
      wp_nav_menu(array(
        'theme_location'    => 'redesocial',
        'depth'             => 2,
        'container'         => 'div',
        'container_class'   => 'collapse navbar-collapse',
        'container_id'      => 'bs-example-navbar-collapse-1',
        'menu_class'        => 'navbar-rede pull-right',
        'fallback_cb'       => 'WP_Bootstrap_Navwalker::fallback',
        'walker'            => new WP_Bootstrap_Navwalker(),
      ));
      ?>
